...
const MyModel2 = mongoose.model('vote', votesSchema);
MyModel2.remove({});

instance = new MyModel2({
    studyId: mongoose.Types.ObjectId("5aaff0a4857f41071758ec85"),
...
instance = new MyModel2({
    studyId: mongoose.Types.ObjectId("5aaff0a4857f41071758ec84"),
