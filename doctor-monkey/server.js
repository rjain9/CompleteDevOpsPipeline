...
Description: This is the modified version of checkbox.io's server script
*/
...
// Read from checkbox-servers file
var rd = readline.createInterface({
	input: fs.createReadStream('checkbox-servers'),
	output: process.stdout,
	console: false
});

// Add those IP addresses to redis server
rd.on('line', function (line) {
	client.lpush("proxy", line);
});

// Change the port of checkbox.io from 80 to 3003
...
// Add a new endpoint to return the CPU usage of the server
